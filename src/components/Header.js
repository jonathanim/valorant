...
const Header = () => {
    return (
        <nav className="container flex justify-center bg-blue-400">
            <Link to="/" className="font-bold px-5 py-2 text-slate-700 rounded-lg hover:bg-slate-100 hover:text-slate-900">Home</Link>
            <Link to="/characters" className="font-bold px-5 py-2 text-slate-700 rounded-lg hover:bg-slate-100 hover:text-slate-900">Characters</Link>
